...
The second result is the transition rule. A lag-2 transition rule plus a small periodic
...
That tradeoff is not an embarrassment. It is evidence that the model really
