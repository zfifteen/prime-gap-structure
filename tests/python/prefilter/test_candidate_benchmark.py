...
MODULE_PATH = ROOT / "benchmarks" / "python" / "prefilter" / "candidate_benchmark.py"
...
def test_exact_calibration_keeps_fixed_points_on_primes():
    """The calibration harness should preserve the prime fixed-point locus on a small panel."""
    module = load_module()
